...
namespace BetterTimeWarp
{
	public static class LegalMamboJambo
	{
		...
		public const string Product = "Better Time Warp";
		public const string Trademark = "BetterTimeWarp™ by MrHappyFace; Continued™ by LinuxGuruGamer; /L Unleashed™ by LisiasT";
	}
}
